...
### 0.0.1 (2025-12-18)
- Initial release
- Support for `Annotated`, string-format, and metadata constraints
- Valid and invalid data generation for basic types
- Support for string length, regex patterns, and numeric bounds
