...
### Added
- Tuple generation for fixed and variadic tuple annotations.

## [0.7.1] - 2026.07.02

### Added
- `Tracer` for generation tracing and debugging.
- `Trace information` for target path, violation, seed, generated value, and value source.
